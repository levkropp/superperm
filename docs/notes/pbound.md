---
layout: math
title: "CH3: an ordering-free bound that beats HPV"
---

# CH3: an ordering-free bound that beats HPV

For years this repo recorded, in [`second_order.md`](second_order) §A3 and
[`lemma_arsenal.md`](lemma_arsenal) §2.7/§8, that **no ordering-free
...
The lesson is the same one [`ordering.md`](ordering) §4 drew from `IN5`:
...
([`code/a2hall.py`](https://github.com/levkropp/superperm/blob/main/code/a2hall.py)). Two questions, in order.
...
[`pentad_lemma.md`](pentad_lemma) advertises **5895** for this same rung —
