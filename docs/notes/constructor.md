---
layout: math
title: "The constructor framework"
---
...
| file | role |
|---|---|
| [`code/census.py`](https://github.com/levkropp/superperm/blob/main/code/census.py) | measure every string on disk in ledger coordinates |
| [`code/superstruct.py`](https://github.com/levkropp/superperm/blob/main/code/superstruct.py) | n-generic group / loop / family / Pentad structure |
| [`code/build.py`](https://github.com/levkropp/superperm/blob/main/code/build.py) | design ↔ walk ↔ string, with independent coordinates |
| [`code/mcolour.py`](https://github.com/levkropp/superperm/blob/main/code/mcolour.py) | the multi-colouring search |
...
jumps". [`notes/second_order.md`](second_order) A1 shows that is the wrong
...
## 6. The exact chainer — [`code/chainer.py`](https://github.com/levkropp/superperm/blob/main/code/chainer.py)
...
**`CH1` is false**, not merely corpus-narrow — see [`pbound.md`](pbound)
...
strings has failed off-distribution — cf. [`notes/ordering.md`](ordering) §4.
...
**The graft** ([`code/graft.py`](https://github.com/levkropp/superperm/blob/main/code/graft.py)) is therefore the minimal
...
implemented, in [`code/saturated6.py`](https://github.com/levkropp/superperm/blob/main/code/saturated6.py)
(`saturated(n, v, cls_of)`), which is what enumerated the 10,068 exact covers,
and in [`code/a1.py`](https://github.com/levkropp/superperm/blob/main/code/a1.py) for the deficiency-1 case.
...
[`code/loopsearch.py`](https://github.com/levkropp/superperm/blob/main/code/loopsearch.py) searches sets of 2-loops. The
