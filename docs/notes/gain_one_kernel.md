...
(NP-hard core: integral exact cover under a forest order). The sharpest
instrument is a **rooted-flow LP relaxation of the forest constraint**
...
large n must come from elsewhere.
