---
layout: math
title: "The SBY identity, the block-count lemma, and split-free s(7) ≥ 5889"
---

# The SBY identity, the block-count lemma, and split-free s(7) ≥ 5889

*Verified by [`code/blockcount.py`](https://github.com/levkropp/superperm/blob/main/code/blockcount.py),
[`code/exit_table.py`](https://github.com/levkropp/superperm/blob/main/code/exit_table.py),
[`code/exit_table_n.py`](https://github.com/levkropp/superperm/blob/main/code/exit_table_n.py),
[`code/split_free_5889.py`](https://github.com/levkropp/superperm/blob/main/code/split_free_5889.py).*
...
[`pentad_lemma.md`](pentad_lemma)), these are the only local facts used
below.
...
[`code/rung_split_free.py`](https://github.com/levkropp/superperm/blob/main/code/rung_split_free.py), and unlike that
...
*[`code/sby_ladder.py`](https://github.com/levkropp/superperm/blob/main/code/sby_ladder.py).*
...
[the certificate](../certificate) needs the absorption lemma, the
...
The reason is measured in [`code/dirty_exits.py`](https://github.com/levkropp/superperm/blob/main/code/dirty_exits.py),
...
*[`code/loop_runs.py`](https://github.com/levkropp/superperm/blob/main/code/loop_runs.py), validated by
[`code/dirty.py`](https://github.com/levkropp/superperm/blob/main/code/dirty.py).*
...
[`pentad_lemma.md`](pentad_lemma) by a completely different route — an
...
*[`code/n7_champions.py`](https://github.com/levkropp/superperm/blob/main/code/n7_champions.py); strings from
...
*[`code/coset_lemma.py`](https://github.com/levkropp/superperm/blob/main/code/coset_lemma.py).*
...
*[`code/omstretch.c`](https://github.com/levkropp/superperm/blob/main/code/omstretch.c), cross-checked by
[`code/omstretch.py`](https://github.com/levkropp/superperm/blob/main/code/omstretch.py).*
...
*[`code/chain_count.py`](https://github.com/levkropp/superperm/blob/main/code/chain_count.py).*
...
Certificate: [`data/e28_certificate.txt`](https://github.com/levkropp/superperm/blob/main/data/e28_certificate.txt).
